...
import {
  ...
  getPresetNamesSafe,
  normalizeComponent,
} from './component-sources.js?ver=0.3.50';
import { extractModelIds, normalizeChatCompletionsUrl, normalizeModelsUrl } from './api-utils.js?ver=0.3.50';
import { injectStatusbarText } from './inject-utils.js?ver=0.3.50';
import { buildExternalStatusbarMessages, createRuntimePromptDiagnostics } from './prompt-builder.js?ver=0.3.50';
import { createPromptLog } from './prompt-log.js?ver=0.3.50';
import { collectSelectedPromptSourceItems, syncPromptSelectionsFromGroups } from './source-selection.js?ver=0.3.50';
